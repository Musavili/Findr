...
import 'package:flutter_app/model/message_data.dart';
...
class _MessagesState extends State<Messages> {
  ...
  Widget build(BuildContext context) {
    return ChannelListCore(//stores user info & rships
      channelListController: channelListController,//allows reloading & pagination
      filter: Filter.and(
        [
